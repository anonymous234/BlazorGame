...
export function Whatever(thing) {
    
    thing.invokeMethodAsync("")
    console.log(thing);
}

export function GameInit (element, dotNetObject) {
    svg = element;
...
export function GameDispose(dotNetObject) {
        ...
        dotNetRef = null;
        if (dotNetObject && dotNetObject.dispose) {
            try { dotNetObject.dispose(); } catch (e) { }
        }
    }
